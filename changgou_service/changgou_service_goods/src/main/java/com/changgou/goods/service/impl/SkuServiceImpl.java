...
public class SkuServiceImpl implements SkuService {
    ...
    public boolean add(Sku sku) {
        return skuMapper.insertSelective(sku) > 0 ? true : false;
    }
    ...
    public boolean update(Sku sku) {
        return skuMapper.updateByPrimaryKeySelective(sku) > 0 ? true : false;
    }
    ...
    public boolean delete(int id) {
        return skuMapper.deleteByPrimaryKey(id) > 0 ? true : false;
    }
